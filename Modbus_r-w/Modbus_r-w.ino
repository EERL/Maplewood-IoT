...
uint16_t writeData[] = {200,200,200}; //Setting CT configurations
uint16_t writeData2[] = {100,100,100};
uint16_t writeData3[] = {0}; //Setting CT directions

uint16_t writeData4[] = {1}; //Setting CT directions
...
static const modbus_t T1 = {1,3,1603,6,nullptr}; //Reading device 1 real power
static const modbus_t T2 = {2,3,1603,6,nullptr}; //Reading device 1 reactive power
...
static const modbus_t TELEGRAMS[] = {T5,T6,T7,T8,T1,T2}; 

//static const modbus_t TELEGRAMS[] = {T5,T6,T1,T2}; 
